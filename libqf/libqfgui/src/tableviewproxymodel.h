#ifndef QF_GUI_TABLEVIEWPROXYMODEL_H
#define QF_GUI_TABLEVIEWPROXYMODEL_H
...
protected:
	...
	int variantCmp(const QVariant &left, const QVariant &right) const;
private:
...
#endif // QF_GUI_TABLEVIEWPROXYMODEL_H
