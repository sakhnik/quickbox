#ifndef QF_GUI_TEXTEDITWIDGET_H
#define QF_GUI_TEXTEDITWIDGET_H
...
class QFGUI_DECL_EXPORT TextEditWidget : public qf::gui::framework::DialogWidget //, public qf::gui::framework::IPersistentOptions
{
	Q_OBJECT
