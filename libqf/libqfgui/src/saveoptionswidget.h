#ifndef QF_GUI_SAVEOPTIONS_WIDGET_H
#define QF_GUI_SAVEOPTIONS_WIDGET_H
...
class QFGUI_DECL_EXPORT SaveOptionsWidget : public QWidget
{
	Q_OBJECT
private:
...
#endif // QF_GUI_SAVEOPTIONS_WIDGET_H
