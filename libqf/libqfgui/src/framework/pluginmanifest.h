#ifndef QF_GUI_FRAMEWORK_PLUGINMANIFEST_H
#define QF_GUI_FRAMEWORK_PLUGINMANIFEST_H
...
class QFGUI_DECL_EXPORT PluginManifest : public QObject
{
	Q_OBJECT
...
#endif // QF_GUI_FRAMEWORK_PLUGINMANIFEST_H
