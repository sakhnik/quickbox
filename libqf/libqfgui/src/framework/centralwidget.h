#ifndef QF_GUI_FRAMEWORK_CENTRALWIDGET_H
#define QF_GUI_FRAMEWORK_CENTRALWIDGET_H
...
class QFGUI_DECL_EXPORT CentralWidget : public QWidget
{
	Q_OBJECT
private:
...
#endif // QF_GUI_FRAMEWORK_CENTRALWIDGET_H
