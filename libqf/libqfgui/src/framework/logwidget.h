#ifndef QF_GUI_FRAMEWORK_LOGWIDGET_H
#define QF_GUI_FRAMEWORK_LOGWIDGET_H
...
namespace qf::gui::model { class LogTableModel; }
...
class QFGUI_DECL_EXPORT LogWidgetTableView : public QTableView
{
	Q_OBJECT
private:
...
class QFGUI_DECL_EXPORT LogWidget : public qf::gui::framework::DockableWidget
{
	Q_OBJECT
private:
	typedef qf::gui::framework::DockableWidget Super;
public:
	...
	void clear();
	virtual void setLogTableModel(qf::gui::model::LogTableModel *m);
	qf::gui::model::LogTableModel* logTableModel();
...
private:
	...
	bool isAutoScroll();
protected:
	qf::gui::model::LogTableModel* m_logTableModel = nullptr;
...
#endif // QF_GUI_FRAMEWORK_LOGWIDGET_H
