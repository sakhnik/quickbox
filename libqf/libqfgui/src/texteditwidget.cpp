...
framework::DialogWidget::ActionMap TextEditWidget::createActions()
{
	...
	QStyle *sty = style();
	{
		...
		auto *a = new qf::gui::Action(ico, tr("Print"), this);
