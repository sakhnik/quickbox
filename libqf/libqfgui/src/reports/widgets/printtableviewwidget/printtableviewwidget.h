#ifndef QF_GUI_REPORTS_PRINTTABLEVIEWWIDGET_H
#define QF_GUI_REPORTS_PRINTTABLEVIEWWIDGET_H
...
class PrintTableViewWidget : public qf::gui::framework::DialogWidget, public qf::gui::framework::IPersistentOptions
{
	Q_OBJECT
private:
...
#endif // QF_GUI_REPORTS_PRINTTABLEVIEWWIDGET_H
