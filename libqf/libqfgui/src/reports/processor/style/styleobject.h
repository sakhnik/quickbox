#ifndef QF_GUI_REPORTS_STYLE_STYLE_OBJECT_H
#define QF_GUI_REPORTS_STYLE_STYLE_OBJECT_H
...
class QFGUI_DECL_EXPORT StyleObject : public QObject, public QQmlParserStatus
{
	Q_OBJECT
