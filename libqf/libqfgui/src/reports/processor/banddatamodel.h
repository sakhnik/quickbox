...
#ifndef QF_GUI_REPORTS_BANDDTAMODEL_H
#define QF_GUI_REPORTS_BANDDTAMODEL_H
...
class QFGUI_DECL_EXPORT BandDataModel : public QObject
{
	Q_OBJECT
private:
...
#endif // QF_GUI_REPORTS_BANDDTAMODEL_H
