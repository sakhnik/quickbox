#ifndef QF_GUI_ACTION_H
#define QF_GUI_ACTION_H
...
class QFGUI_DECL_EXPORT Action : public QAction
{
	Q_OBJECT
...
public:
	...
	Q_INVOKABLE qf::gui::Action *addMenuInto(const QString &id, const QString &text);
	Q_INVOKABLE qf::gui::Action *addMenuAfter(const QString &id, const QString &text);
	Q_INVOKABLE qf::gui::Action *addMenuBefore(const QString &id, const QString &text);
	Q_INVOKABLE qf::gui::Action *addSeparatorInto(const QString &id = QString());
	Q_INVOKABLE qf::gui::Action *addSeparatorBefore(const QString &id = QString());
private:
	QWidget* parentMenu();
};
