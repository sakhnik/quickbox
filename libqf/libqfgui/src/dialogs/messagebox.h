#ifndef QF_GUI_DIALOGS_MESSAGEBOX_H
#define QF_GUI_DIALOGS_MESSAGEBOX_H
...
class QFGUI_DECL_EXPORT MessageBox : public QMessageBox
{
	Q_OBJECT
...
#endif // QF_GUI_DIALOGS_MESSAGEBOX_H
