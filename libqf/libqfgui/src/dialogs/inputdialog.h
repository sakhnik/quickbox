#ifndef QF_GUI_DIALOGS_INPUTDIALOG_H
#define QF_GUI_DIALOGS_INPUTDIALOG_H
...
class QFGUI_DECL_EXPORT InputDialog : public QInputDialog
{
	Q_OBJECT
...
public:
	explicit InputDialog(QWidget *parent = nullptr, Qt::WindowFlags flags = Qt::WindowFlags());
};

}}}

#endif // QF_GUI_DIALOGS_INPUTDIALOG_H
