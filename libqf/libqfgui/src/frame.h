#ifndef QF_GUI_FRAME_H
#define QF_GUI_FRAME_H
...
class QFGUI_DECL_EXPORT Frame : public QFrame
{
	Q_OBJECT
	...
	Q_PROPERTY(qf::gui::LayoutTypeProperties* layoutProperties READ layoutTypeProperties WRITE setLayoutTypeProperties)
