#ifndef QF_GUI_LAYOUTPROPERTIESATTACHED_H
#define QF_GUI_LAYOUTPROPERTIESATTACHED_H
...
class QFGUI_DECL_EXPORT LayoutPropertiesAttached : public QObject
{
	Q_OBJECT
	...
	Q_PROPERTY(qf::gui::LayoutTypeProperties::SizePolicy horizontalSizePolicy READ horizontalSizePolicy WRITE setHorizontalSizePolicy NOTIFY horizontalSizePolicyChanged)
	Q_PROPERTY(qf::gui::LayoutTypeProperties::SizePolicy verticalSizePolicy READ verticalSizePolicy WRITE setVerticalSizePolicy NOTIFY verticalSizePolicyChanged)
public:
...
class QFGUI_DECL_EXPORT LayoutProperties : public QObject
{
	Q_OBJECT
public:
