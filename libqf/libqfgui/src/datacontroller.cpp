...
qf::gui::model::DataDocument *DataController::document(bool throw_exc) const
{
...
void DataController::setDocument(qf::gui::model::DataDocument *doc)
{
	if(m_document != doc) {
		m_document = doc;
		connect(doc, &qf::gui::model::DataDocument::loaded, this, &DataController::documentLoaded);
		connect(doc, &qf::gui::model::DataDocument::valueChanged, this, &DataController::documentValueChanged);
		connect(doc, &qf::gui::model::DataDocument::aboutToSave, this, &DataController::documentAboutToSave);
